...
MODULE_PATH = 'components.cognitive.command_base'
EXPORTS = ['CommandArg', 'CommandArgs', 'CommandBase', 'CommandCategory', 'CommandMetadata', 'CommandResult', 'command_metadata', 'get_command', 'list_commands', 'list_commands_by_category']
