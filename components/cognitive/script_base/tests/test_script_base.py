...
MODULE_PATH = 'components.cognitive.script_base'
EXPORTS = ['LogLevel', 'ScriptArg', 'ScriptArgs', 'ScriptBase', 'ScriptCategory', 'ScriptMetadata', 'ScriptResult', 'get_script', 'list_scripts', 'script_metadata']
