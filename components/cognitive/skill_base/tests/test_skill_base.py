...
MODULE_PATH = 'components.cognitive.skill_base'
EXPORTS = ['CompositeSkill', 'ConfidenceLevel', 'InputContract', 'OutputContract', 'QualityScore', 'SkillBase', 'SkillCategory', 'SkillContext', 'SkillMetadata', 'SkillPhase', 'SkillResult', 'get_skill', 'list_skills', 'skill_metadata']
