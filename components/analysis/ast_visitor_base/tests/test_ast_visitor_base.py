...
MODULE_PATH = 'components.analysis.ast_visitor_base'
EXPORTS = ['BaseConnascenceVisitor', 'ComplexityVisitor', 'GodObjectVisitor', 'MagicLiteralVisitor', 'ParameterPositionVisitor', 'VisitorContext']
