...
MODULE_PATH = 'components.analysis.pattern_matcher'
EXPORTS = ['MatchResult', 'PatternConfig', 'PatternDatabase', 'PatternDefinition', 'PatternMatch', 'PatternMatcher', 'PatternType', 'SignalLevel', 'create_matcher_from_wordlist']
